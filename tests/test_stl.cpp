...
void print_vec(const string& name, const vector<DATA>& v) {
	cout << name << ": \n";
...
int main() {
     ...
     * */
	//list::iterator temp_begin = clist.begin();
	...
	*/
	...
	cout << "First lambda odd number in list is: " << *odd_iter3 << endl;
	odd_iter3++;
